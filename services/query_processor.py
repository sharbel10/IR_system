...
class QueryProcessor:
    ...
    def process_and_search(self, raw_query, search_mode="parallel", k1=1.5, b=0.75, top_k=10, apply_expansion=False):
        ...
        if search_mode == "tfidf":
            ...
            return self.hybrid_indexer.embedding_indexer.search(corrected_query, top_k=top_k)
